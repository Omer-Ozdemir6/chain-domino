...
const ECONOMY_CHARMS: readonly CharmDef[] = [
  ...
  { id: 'perfect_landing', name: 'Tam İsabet', description: "Raundu skoru TAM OLARAK hedefe eşit bitirirsen +$25 bonus.", cost: 12, rarity: 'LEGENDARY', createHooks: () => ({ onRoundEnd: (ctx) => (ctx.finalScore === ctx.target ? 25 : 0) }) },
